...
Mostly Claude-generated and still under review!
...
**c\_{x_A} and the counting equation** (`c_xA_counting`):
...
- Johnsen, M. & Johansson, U. (2005). _Efficient Modeling of Analogy_.
...
- Greenhill, C. (2000). _The complexity of counting colourings and independent sets
  in sparse graphs and hypergraphs._ Establishes #VERTEX-COVER is #P-hard.

- Valiant, L. G. (1979). _The complexity of computing the permanent._
